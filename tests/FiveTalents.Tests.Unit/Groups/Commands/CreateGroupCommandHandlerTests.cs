...
public class CreateGroupCommandHandlerTests : IDisposable
{
    ...
    public async Task Handle_WithValidCommand_ReturnsPositiveId()
    {
        ...
        var command = new CreateGroupCommand(1, "Monday Night Group", null, gt.Id,
    ...
    {
        var gt = await SeedGroupTypeAsync();
        var command = new CreateGroupCommand(1, "Bible Study", "Wed evenings", gt.Id,
    ...
    {
        var gt = await SeedGroupTypeAsync();
        var command = new CreateGroupCommand(1, "Evening Group", null, gt.Id,
    ...
    {
        var gt = await SeedGroupTypeAsync();
        var command = new CreateGroupCommand(1, "Group", null, gt.Id,
